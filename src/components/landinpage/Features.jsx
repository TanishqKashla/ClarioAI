    ...
    const features = [
        {
            ...
            className:
                "col-span-3 border-b lg:border-r dark:border-neutral-800",
        },
        {
            ...
            className: "border-b col-span-3 dark:border-neutral-800",
        },
        {
            ...
            className:
                "col-span-3 md:col-span-4 lg:border-r  dark:border-neutral-800",
        },
        {
            ...
            className: "col-span-3 md:col-span-2 border-b lg:border-none",
        },
    ];
    return (
        <div className="relative z-20 pt-16 pb-1 lg:pt-32 lg:pb-20 mx-auto max-w-2xl lg:max-w-5xl">
            <div className="px-8">
                <h4
            ...
            <div className="relative ">
                <div
                    className="grid grid-cols-6 mt-8 xl:border rounded-md dark:border-neutral-800">
